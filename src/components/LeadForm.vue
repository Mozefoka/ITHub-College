  ...
  <section class="lead-form" id="lead-form">
      <form class="lead-form__form" @submit.prevent="handleSubmit">
        <div class="lead-form__grid">
          ...
          <div class="lead-form__group">
            <label class="lead-form__label" for="contactMethod">Как с вами связаться?</label>
            <select
              id="contactMethod"
        ...
        <div class="lead-form__consents">
          ...
          <label class="lead-form__consent">
            ...
            <span class="lead-form__consent-text">
              Согласен/а на получение маркетинговых рассылок
            </span>
          </label>
        </div>

        <div class="lead-form__submit">
          <ButtonCta type="submit" :disabled="submitting" text="ПОСТУПИТЬ" :size="props.btnSize">
